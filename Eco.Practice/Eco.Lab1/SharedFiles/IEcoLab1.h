...
typedef struct IEcoLab1VTbl {
    ...
    /* IEcoLab1 */
    void* (ECOCALLMETHOD *MyBsearch)(/* in */ IEcoLab1Ptr_t me, /* in */ const void *key, /* in */ const void *base, /* in */ uint32_t nmemb, /* in */ uint32_t size, /* in */ int32_t (*compar)(const void *, const void *));
